...
export const titleTemplate = (description: string) =>
...
export const releaseDateTemplate = (description: string) =>
	new ArgumentBuilder<string>()
		.setName('releasedate')
		.setDescription(description)
		.setDisplayedType('string')
...
export const youtubemetadataidTemplate = (description: string) =>
	new ArgumentBuilder<string>()
		...
		.setAutoComplete((v) => [v.slice(0, 30)])
		.setValidator((v) => v.length <= 30);
export const studioTemplate = (description: string) =>
	new ArgumentBuilder<string>()
		.setName('studio')
		.setDescription(description)
		.setDisplayedType('string')
		...
		.setAutoComplete((v) => [v.slice(0, 30)])
		.setValidator((v) => v.length <= 30);
export const plotTemplate = (description: string) =>
	new ArgumentBuilder<string>()
		.setName('plot')
		.setDescription(description)
		.setDisplayedType('string')
		...
		.setValidator(() => true);
export const trailerTemplate = (description: string) =>
	new ArgumentBuilder<string>()
		.setName('trailer')
		.setDescription(description)
		.setDisplayedType('string')
		...
		.setAutoComplete((v) => [v])
		.setValidator(() => true);
export const seasonnumberTemplate = () =>
	new ArgumentBuilder<number>()
		.setName('seasonnumber')
		.setDescription(
			'The number of the season (if between: the affected seasons will change accordingly)'
		)
...
export const episodeNumberTemplate = () =>
	new ArgumentBuilder<number>()
		.setName('episode')
		.setDescription(
			'The number of the episode (if between: the affected episodes will change accordingly)'
		)
		.setDisplayedType('number')
		.setParser(parseNumber)
		.setAutoComplete((value, values) => {
...
export const podcastEpisodeNumberTemplate = () =>
	new ArgumentBuilder<number>()
		.setName('episode')
		.setDescription(
			'The number of the episode (if between: the affected episodes will change accordingly)'
