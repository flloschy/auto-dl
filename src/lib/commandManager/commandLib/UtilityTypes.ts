...
export type internalAsyncExecutionFunction = (
	handler: ExecutionHandler,
	values: commandValueObject
) => void;
export type internalInstantExecutionFunction = (values: commandValueObject) =>
	| Promise<
			| {
					success: true;
					lines: logMessage[];
...
export type executionFunction<T extends 'async' | 'instant'> = T extends 'async'
	? (values: commandValueObject) => internalAsyncExecutionFunction
	: internalInstantExecutionFunction;
