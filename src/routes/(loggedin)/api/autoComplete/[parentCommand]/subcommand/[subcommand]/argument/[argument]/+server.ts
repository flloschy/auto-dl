...
const logIt = Logger.getLogger('api subcommand/argument');
export const POST = async ({ params, request }) => {
	...
	const internalSubCommand = Object.values(internalCommand.subCommands).find(
	...
	const internalArgument = internalSubCommand.arguments.find((arg) => arg.name == argument);
	if (!internalArgument) {
