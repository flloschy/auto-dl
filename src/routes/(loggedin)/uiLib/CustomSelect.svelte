<script lang="ts">
	import type { apiTypingReturn, commandValueObject } from "$lib/commandManager/commandLib/UtilityTypes";
...
<style>
    ...
    .customSelect.invalid input, .customSelect.invalid input::placeholder {
